...
def get_museum_apartment_of_kuindzhi():
    # адрес страницы для парсинга
    url = 'https://ru.wikipedia.org/wiki/Музей-квартира_А._И._Куинджи'
    # путь, куда будет сохранен результат парсинга
    file_path = f'./{data_directory}/museum_apartment_of_kuindzhi.txt'
