...
def get_state_museum_of_urban_sculpture():
    # адрес страницы для парсинга
    url = 'https://ru.wikipedia.org/wiki/Государственный_музей_городской_скульптуры'
    # путь, куда будет сохранен результат парсинга
    file_path = f'./{data_directory}/state_museum_of_urban_sculpture.txt'
