...
museums_map = {'Государственный Эрмитаж': 'hermitage', 'Музей Фаберже': 'faberzhe', 'Государственный Русский музей': 'rusmuseum', 'Летний сад': 'summer_garden', 'Государственный музей городской скульптуры': 'state_museum_of_urban_sculpture', 'Музей-усадьба П. П. Чистякова': '', 'Музей-квартира А. И. Куинджи': 'museum_apartment_of_kuindzhi', 'Музей современного искусства Эрарта': 'erarta', 'Новый музей': '', 'Музей прикладного искусства СПбГХПА им.А.Л.Штиглица': ''}
